namespace Datos {
    internal class Usuarios {
        ...
        Usuarios(int id_usuario, string username, string password) {
        ...
        Usuarios(int id_usuario, string username, string password, string tipo, int id_medico, bool activo) {
            this.id_usuario = id_usuario;
            this.username = username;
            this.password = password;
            this.tipo = tipo;
        ...
        public string Usuario { get => username; set => username = value; }
