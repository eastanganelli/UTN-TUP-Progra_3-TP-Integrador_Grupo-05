...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="contenedor listado">
        ...
        <div class="table-meta">
            <span>Se encontraron <strong>
                <asp:Label ID="lblContador" runat="server" /></strong> turnos</span>
            <span>Página <strong>
                <asp:Label ID="lblPaginaActual" runat="server" /></strong> de <strong>
                    <asp:Label ID="lblTotalPaginas" runat="server" /></strong></span>
        </div>
